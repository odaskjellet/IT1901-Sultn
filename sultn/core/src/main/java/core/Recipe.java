...
/**
 * A Recipe object A Recipe object represents one recipe containing name of Recipe, id for CookBook
 * class' HashMap, array of ingredients objects and array of string instructions.
 */
public class Recipe {
  private String name;
  private int id;
