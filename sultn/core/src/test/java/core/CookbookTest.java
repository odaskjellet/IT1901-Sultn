...
public class CookbookTest {
  ...
  // List<Ingredient> pannekakeIngredients = new ArrayList<Ingredient>(Arrays.asList(melk, mel,
  // egg));
  // List<String> pannekakeInstructions = new ArrayList<String>(Arrays.asList("1. Mål opp mel og
  // melk",
